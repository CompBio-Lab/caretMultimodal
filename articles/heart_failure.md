...
[`summary()`](https://rdrr.io/r/base/summary.html) are the resampling
summaries generated by `caret` and may differ from metrics calculated
directly from out-of-fold predictions. For example, the reported ROC
value is the mean ROC across resampling folds, whereas
[`plot_roc()`](https://compbio-lab.github.io/caretMultimodal/reference/plot_roc.md)
calculates AUROC from the pooled out-of-fold predictions. See
[`compute_metric()`](https://compbio-lab.github.io/caretMultimodal/reference/compute_metric.md)
...
![](heart_failure_files/figure-html/unnamed-chunk-4-3.png)
...
![](heart_failure_files/figure-html/unnamed-chunk-4-4.png)
...
![](heart_failure_files/figure-html/unnamed-chunk-4-5.png)
